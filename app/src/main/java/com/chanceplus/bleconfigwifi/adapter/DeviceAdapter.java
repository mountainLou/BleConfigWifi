package com.chanceplus.bleconfigwifi.adapter;
...
public class DeviceAdapter extends BaseAdapter {
    ...
    public Object getItem(int position) {
        if (bleDeviceList.size() < position){
            return null;
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            holder.btn_wifi_config = (Button) convertView.findViewById(R.id.btn_wifi_config);
        }
        ...
        if (bleDevice != null) {
            ...
            if (isConnected) {
                holder.img_blue.setImageResource(R.drawable.ic_bluetooth_connected_blue_24dp);
                ...
                holder.img_blue.setImageResource(R.drawable.ic_bluetooth_searching_black_24dp);
        ...
        holder.btn_wifi_config.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mListener != null) {
    ...
    public void addDevice2Top(BleDevice bleDevice){
        removeDevice(bleDevice);
